...
- เธอคงไม่รู้ ว่าฉันเองยังไม่มีใคร หากเป็นเธอ ก็คงเข้าที [LOSO - ฝนตกที่หน้าต่าง](https://youtu.be/SXy-v1KbF4k?t=53)
- ทีละนิดทีละน้อย รักทีละหน่อย [ทีละนิด - กอล์ฟ-ไมค์](https://youtu.be/WxD24XRx0yM?t=57) 