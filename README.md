...
- มาทำไมให้อายบ้านนา เล่านวลน้อง ไม่ต้องกลับคืนมา [กลับมาทำไม - ทิดเซียง](https://youtu.be/tw5LTC__YWk?t=24)
- มารักทำไมตอนนี้ ตอนที่จะเสียฉันไป ทั้งๆ ที่ฉันทุ่มให้หมดใจ แต่เธอกลับทิ้งมัน [มารักทำไมตอนนี้ - Am Fine](https://youtu.be/maz6gnq-n6g?t=12)
- มันเจ็บจะขาดใจอยู่ตรงหน้าเธอ แต่ต้องเก็บไว้ไม่แสดงว่าเสียใจ [ขาดใจ - Pancake](https://youtu.be/l9MRG7XV3V0?t=43)
