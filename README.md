...
-เธอในทุกๆวัน ในเพลงนี้ มันจะร้องว่าฉันรักเธอมากเเค่ไหน ท้วงทำนองแทนความในใจที่อยากจะบอก ให้เธอได้รู้ ถึงแม้จะไม่ได้ยิน [PONWP - ในเพลงนี้ (This song)](https://youtu.be/dWqjEQ2Gvrs?t=81)
